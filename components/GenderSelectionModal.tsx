...
const GenderSelectionModal = ({ onSelect }: GenderSelectionModalProps) => {
  return (
    <div className="fixed inset-0 bg-[#5940df] bg-opacity-50 flex items-center justify-center z-50 text-white">
      <div className="bg-[#9381f5] rounded-lg p-8 max-w-md w-full">
